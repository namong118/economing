        ...
        <div style={{ maxWidth: '400px', width: '100%', textAlign: 'center' }}>
          ...
          {MOCK ? (
            <p style={{ fontSize: '14px', color: '#64748B', lineHeight: '1.7', marginBottom: '24px' }}>
              ...
              <span style={{ fontSize: '12px', color: '#21C58E', fontWeight: '600' }}>🧪 개발 모드 — 이메일 인증 없음</span>
            </p>
          ) : (
            <p style={{ fontSize: '14px', color: '#64748B', lineHeight: '1.7', marginBottom: '24px' }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '12px', fontWeight: '700', color: '#21C58E', marginBottom: '8px' }}>
              ☀️ 노밍이 기다리고 있어요
            </p>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '12px', fontWeight: '700', color: '#21C58E', marginBottom: '10px' }}>
                ☀️ 노밍과 함께
              </p>
              {['경제 공부 순서 찾기', '나에게 맞는 성장 단계', '쉬운 경제 코칭'].map(item => (
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#64748B', margin: 0 }}>
            이미 계정이 있으신가요?{' '}
            <Link to="/login" style={{ color: '#21C58E', fontWeight: '700', textDecoration: 'none' }}>
              로그인
            </Link>
          </p>
        </div>
