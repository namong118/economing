    ...
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '96px 32px 120px' }}>
      ...
      <section style={{ marginBottom: '112px' }}>
        <h1 style={{
          ...
          color: 'var(--c-ink)', letterSpacing: '-0.02em', marginBottom: '28px',
        }}>
          박남영
        </h1>
        <p style={{ fontSize: '17px', color: 'var(--c-slate)', lineHeight: '1.9', whiteSpace: 'pre-line', marginBottom: '18px' }}>
          {'디자인과를 졸업해 프로그래밍을 공부했고,\n게임 클라이언트 개발자로 3년 4개월을 보냈습니다.\n지금은 AI 개발자가 되기 위해 공부하고 있습니다.'}
        </p>
        <p style={{ fontSize: '17px', color: 'var(--c-slate)', lineHeight: '1.9', marginBottom: 0 }}>
          새로운 분야를 배우고 알아가는 것을 좋아합니다.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '112px' }}>
        ...
        <Quote emphasized style={{ marginBottom: 0 }}>
          ECONOMING은 그 선택 이후 만든 첫 결과물입니다.
        </Quote>
      </section>
      ...
      <section>
        <div style={{
          ...
          paddingTop: '24px', borderTop: '1px solid var(--c-line)',
        }}>
          <span style={{ fontSize: '13.5px', color: 'var(--c-muted)', fontFamily: 'monospace' }}>
            nmnmxe@gmail.com
          </span>
          <span style={{ fontSize: '13.5px', color: 'var(--c-line)' }}>·</span>
          <a
            ...
            style={{
              ...
              fontSize: '13.5px', color: 'var(--c-muted)', fontFamily: 'monospace',
              textDecoration: 'none',
            }}
          >
            github.com/namong118 <ArrowRight size={12} />
          </a>
        </div>
      </section>
