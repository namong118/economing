    ...
    <div style={{ marginBottom: '12px' }}>
      <button
        ...
        style={{
          ...
          background: 'none', border: '0.5px solid #d4ede3',
      ...
      {open && (
        <div style={{ border: '0.5px solid #d4ede3', borderTop: 'none', borderRadius: '0 0 12px 12px', overflow: 'hidden' }}>
          {[
            { k: 'user.id',    v: user?.id },
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        border: '0.5px solid #d4ede3', borderRadius: '12px',
        ...
        {profile?.avatar_url ? (
          ...
          <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'linear-gradient(135deg,#21C58E,#1AAD7D)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '26px', color: '#fff', fontWeight: '700', border: '3px solid #fff', boxShadow: 'none', flexShrink: 0 }}>
            {(profile?.nickname || user.email || '?')[0].toUpperCase()}
          </div>
        )}
        <div style={{ flex: 1, minWidth: 0 }}>
          <h2 style={{ fontSize: '20px', fontWeight: '900', color: '#085041', letterSpacing: '-0.6px', marginBottom: '2px' }}>
      ...
      {/* ── 2. 성장 단계 ── */}
      <div style={{ background: '#fff', borderRadius: '12px', border: '0.5px solid #d4ede3', padding: '20px', marginBottom: '12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
          ...
          <div>
            <p style={{ fontSize: '17px', fontWeight: '900', color: '#085041', letterSpacing: '-0.5px' }}>{currentLevel.label} 단계</p>
          ...
          {LEVELS.map((l, i) => {
            ...
            return (
              <div key={l.key} style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
                <div title={l.label} style={{ width: isCurrent ? '28px' : '21px', height: isCurrent ? '28px' : '21px', borderRadius: '50%', flexShrink: 0, background: isCurrent ? '#21C58E' : isPast ? '#DCF5EB' : '#F4FAF6', border: isCurrent ? '2px solid #fff' : isPast ? '0.5px solid #d4ede3' : '0.5px solid #d4ede3', boxShadow: isCurrent ? '0 0 0 3px rgba(33,197,142,0.2)' : 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: isCurrent ? '14px' : '10px' }}>
                  {l.emoji}
                </div>
      ...
      {isOnboarded ? (
        <div style={{ background: '#fff', borderRadius: '12px', border: '0.5px solid #d4ede3', padding: '20px', marginBottom: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
              {invInfo && (
                <div style={{ background: '#F4FAF6', border: '0.5px solid #d4ede3', borderRadius: '10px', padding: '10px 12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', fontWeight: '700', color: '#085041' }}>{invInfo.label}</p>
                  </div>
                </div>
              )}
              {occInfo && (
                <div style={{ background: '#F4FAF6', border: '0.5px solid #d4ede3', borderRadius: '10px', padding: '10px 12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', fontWeight: '700', color: '#085041' }}>{occInfo.label}</p>
                  </div>
                </div>
              )}
            </div>
            {interests.length > 0 && (
              <div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                  {interests.map(tag => (
                    <span key={tag} style={{ fontSize: '12px', fontWeight: '700', color: '#21C58E', background: '#F4FAF6', border: '0.5px solid #d4ede3', borderRadius: '100px', padding: '4px 12px' }}>{tag}</span>
                  ))}
                </div>
              </div>
            )}
        ...
        <div style={{ background: '#fff', borderRadius: '12px', border: '0.5px dashed #d4ede3', padding: '28px', textAlign: 'center', marginBottom: '12px' }}>
          ...
          <p style={{ fontSize: '15px', fontWeight: '800', color: '#085041', marginBottom: '5px' }}>경제 성장 진단을 완료해보세요</p>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '8px' }}>
        <p style={{ fontSize: '15px', fontWeight: '800', color: '#085041', letterSpacing: '-0.4px', lineHeight: 1.3 }}>
          {term.term}
        </p>
        <span style={{
        ...
        {confirmDel ? (
          <div style={{ display: 'flex', gap: '5px' }}>
            <button
              ...
              style={{ padding: '4px 10px', borderRadius: '7px', background: '#F8FAFC', border: '0.5px solid #d4ede3', fontSize: '11px', fontWeight: '600', color: '#888780', cursor: 'pointer' }}
            >
              취소
            </button>
            <button
          ...
          <button
            ...
            style={{ padding: '4px 10px', borderRadius: '7px', background: 'none', border: '0.5px solid #d4ede3', fontSize: '11px', fontWeight: '600', color: '#888780', cursor: 'pointer' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = '#FECACA'; e.currentTarget.style.color = '#EF4444'; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = '#d4ede3'; e.currentTarget.style.color = '#888780'; }}
          >
            삭제
          </button>
        )}
      ...
      <div style={{ position: 'relative', marginBottom: '16px' }}>
        ...
        <input
          ...
          style={{
            ...
            borderRadius: '14px', border: '0.5px solid #d4ede3',
            fontSize: '14px', color: '#085041', background: '#fff',
            ...
            <div key={step.step} style={{ display: 'flex', gap: '12px' }}>
              ...
              <div
                style={{
                  ...
                  background: '#fff',
                  border: `0.5px solid ${isRecommended ? step.color + '50' : '#d4ede3'}`,
